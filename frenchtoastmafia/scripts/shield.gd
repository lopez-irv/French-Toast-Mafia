...
func open_interact_menu():
	...
	#print(interact_menu.consumable)
	#print("shield node name: ", name)
	#print("shield in tree? ", is_inside_tree())
	#print("shield interact menu: ", get_tree().current_scene.find_child("fruit_interact", true, false))
